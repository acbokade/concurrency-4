...
int main()
{
    ...
    //creating hands
    b2BodyDef bodydef5;
    bodydef5.position=b2Vec2((160.f)/SCALE,(233.f)/SCALE);
    ...
    //creating hands
    b2BodyDef bodydef6;
    bodydef6.position=b2Vec2((240.f)/SCALE,(233.f)/SCALE);
    ...
    jointDef3.localAnchorA.Set(-10.f/SCALE,-15.0f/SCALE);//the top right corner of the box
    jointDef3.localAnchorB.Set(50.f/SCALE,0.f/SCALE);//center of the circle
    //jointDef3.enableLimit = true;       
    jointDef3.collideConnected = false;
    //jointDef3.lowerAngle = 70 * DEGTORAD;
    //jointDef3.upperAngle = 110 * DEGTORAD;
    ...
    jointDef4.localAnchorA.Set(10.f/SCALE,-15.0f/SCALE);//the top right corner of the box
    jointDef4.localAnchorB.Set(-50.f/SCALE,0.f/SCALE);//center of the circle
    //jointDef4.enableLimit = true;
    jointDef4.collideConnected = false;
    //jointDef4.lowerAngle = -110 * DEGTORAD;
    //jointDef4.upperAngle = -70 * DEGTORAD;

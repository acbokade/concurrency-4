...
int main()
{
    ...
    //creating legs
    b2BodyDef bodydef3;
    bodydef3.position=b2Vec2((200.f-temp1)/SCALE,(315.f+temp1)/SCALE);
    ...
    //creating legs
    b2BodyDef bodydef4;
    bodydef4.position=b2Vec2((200.f+temp1)/SCALE,(315.f+temp1)/SCALE);
    ...
    jointDef1.localAnchorB.Set((temp1-12)/SCALE,-temp1/SCALE);//center of the circle
    ...
    jointDef2.localAnchorB.Set(-(temp1-12)/SCALE,-temp1/SCALE);//center of the circle
    jointDef2.enableLimit = true;
    jointDef2.collideConnected = false;
    jointDef2.lowerAngle = -60 * DEGTORAD;
    jointDef2.upperAngle = -30 * DEGTORAD;
    ...
    jointDef3.localAnchorA.Set(-10.f/SCALE,-40.0f/SCALE);//the top right corner of the box
    jointDef3.localAnchorB.Set(25.f/SCALE,0.f/SCALE);//center of the circle
    jointDef3.collideConnected = false;
    jointDef3.enableLimit = true;
    jointDef3.referenceAngle = 0 * DEGTORAD;  
    jointDef3.lowerAngle = -10 * DEGTORAD;
    jointDef3.upperAngle =10 * DEGTORAD;
    ...
    jointDef4.localAnchorA.Set(10.f/SCALE,-40.0f/SCALE);//the top right corner of the box
    jointDef4.localAnchorB.Set(-25.f/SCALE,0.f/SCALE);//center of the circle
    jointDef4.enableLimit = true;
    jointDef4.referenceAngle = 0 * DEGTORAD;    
    jointDef4.collideConnected = false;
    jointDef4.lowerAngle = -10 * DEGTORAD;
    jointDef4.upperAngle = 10 * DEGTORAD;
    ...
    sf::RectangleShape recta3(sf::Vector2f(60, 10));
    recta3.setFillColor(sf::Color(0, 0, 150));

    sf::RectangleShape recta4(sf::Vector2f(60, 10));
